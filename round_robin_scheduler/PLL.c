...
#define SYSCTL_RCC2_R           (*((volatile uint32_t*)(SYSCTL_BASE + 0x070)))
#define SYSCTL_RCC_R            (*((volatile uint32_t*)(SYSCTL_BASE + 0x060)))
#define SYSCTL_RIS_R            (*((volatile uint32_t*)(SYSCTL_BASE + 0x050)))
